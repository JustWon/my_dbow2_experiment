...
private:
	...
	string train_desc_dir_path = "";
	string test_desc_dir_path = "";
	...
	string eval_desc;
	string network_model; // vanilla network, large-scale-training, bigger_feature_size,
...
public:
	DW_Config() {
		...
		string _eval_desc = pt.get<string>("Experiment_parameters.eval_desc");
		string _network_model = pt.get<string>("Experiment_parameters.network_model");
...
//		test_img_dir_path = "/media/dongwonshin/Ubuntu Data/Datasets/FAB-MAP/Image Data/"+ eval_dataset +" ManualLC/images";
	...
	void printConfig()
	{
		...
		cout << "=========================================" << endl
			 ...
			 << "eval_desc = " << eval_desc.c_str() << endl
	...
	void resultLogOrganization()
	{
		...
		ofs << "eval_desc = " << eval_desc << endl;
		ofs << "network_model = " << network_model << endl;
	...
	string getEvalDesc() {return eval_desc;}
	string getNetworkModel() {return network_model;}
	...
	string getTrainDescDirPath() {return train_desc_dir_path;}
	string getTestDescDirPath() {return test_desc_dir_path;}
	...
	float* getSurfParam() {return surf_param;}
};
